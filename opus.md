...
| keep | `C:\dev\apps\keep\` | `leftjap/keep` | 루트 | 운영 중, B-53 동기화 레이스 수정 검증 중 |

---

## 2. 백로그 → backlog.md

**파일:** https://raw.githubusercontent.com/leftjap/playbook/main/backlog.md
**로컬:** C:\dev\playbook\backlog.md
