...
> 결과는 산출물 품질에만 반영하고, ALT 과정 자체를 출력하지 않는다.

#### 적용 조건
- 분석·설계·오류탐지·시뮬레이션 산출물을 출력할 때 수행한다.
- 운영 문서(playbook.md, AGENTS.md, common-rules.md)를 3행 이상 변경하는 작업지시서를 출력할 때 수행한다.
...
| A-2 | 참조 정합성 | 언급한 URL·경로·ID·상태값이 실제 문서와 일치하는가? |
