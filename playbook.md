...
3. 사용자가 작업을 지정하면 해당 프로젝트의 AGENTS.md를 크롤링한다 (크롤링 전 제외 목록 확인).
...
| L-14 | decisions/ 폴더 용도 범위 | 큰 결정 근거만 보관. 사소한 건 교훈 1줄. 트리거: ①playbook/common-rules 새 섹션·규칙 체계 신설 ②아키텍처·스키마 변경 ③도구·스택 전환 검토 — 해당 시 작업지시서에 decisions/ 생성 + INDEX.md 갱신 Step 자동 포함 | 전체 |
