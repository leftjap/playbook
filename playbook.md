...
- 3/25: B-13+B-14 세션 자동저장/복원 정비. visibilitychange/beforeunload 저장, 30초 주기 자동저장, init()에서 복원 시 운동 화면 직접 전환.
- 3/25: 유산소 종목 스톱워치 UI 추가 (시작/일시정지/재개/완료). 누적 방식. 수동 입력도 유지. 세션 복원 시 타이머 상태 복원.
