...
- 3/27: 작업지시서 실행 주체를 Claude Code로 변경 — playbook.md 6-6 삭제 + 실행 규칙 추가, AGENTS.md 7개 일괄 수정. B-22~B-27 백로그 추가, F-01 설계원칙 추가, L-14 교훈 등록, list→decisions 폴더명 변경. B-28 후속 — 헤더 시계 전환, 볼륨 부분매칭, 색상 분리, 휴식 타이머 제거.
